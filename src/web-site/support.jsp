...
<td width="200" height="174" align="center" valign="top" style="background-color: D1DFFF;">
...
<center>
<table border="0">
<tr><td colspan="2" class="title2">Support</td></tr>
<tr><td class="promotext"><table border="0" width="100%" cellspacing="5"><tr><td class="promotext">
    &nbsp;&nbsp;&nbsp; We offer paid support for services that are out of the scope of the open source initiative.<br><br>
    &nbsp;&nbsp;&nbsp; <b>Paid services:</b>
    <li>installation;</li>
    <li>setting up development environment for automated build management (CVS, Anthill, Resin);</li>
    <li>custom development.</li>
<br><br>
    &nbsp;&nbsp;&nbsp; <b>Free services:</b>
    <li>bug-fixing;</li>
    <li>answering questions that are not found in our FAQ.</li>    
    <br>
