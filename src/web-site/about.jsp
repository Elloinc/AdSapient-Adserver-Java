...
<br><br>
<tr><td><nobr><a class="promotext2" href="about.jsp">&nbsp;&nbsp;&nbsp;About AdSapient</a></nobr></td></tr>
...
<tr><td colspan="2" class="title2">About AdSapient</td></tr>
<tr><td colspan="2" class="promotext">&nbsp;&nbsp;&nbsp;AdSapient was initially developed by the Generation_P Company based in Munich, Germany, with the development office in Minsk, Belarus. You can find more information about the Company's <a href="http://www.generation-p.com/managment.jsp" class="promotext2">management</a> and <a href="http://www.generation-p.com/services.jsp" class="promotext2">services</a>  at <a class="promotext2" href="http://www.generation-p.com">http://www.generation-p.com</a>.</td></tr>
<tr><td colspan="2" class="promotext">It is currently supported by a group of developers who used to work at Generation_P and now
voluntarily work part-time on this open source project.</td></tr>

<tr><td class="promotext">
<p><br>

                            <strong>Our contact information:</strong><br><br>

    <strong>Address in Belarus:</strong><br>
							 Voronjanskogo Str., 13 - 1,
                            118<br>
                            220007
                            Minsk<br>
                            Republic 
