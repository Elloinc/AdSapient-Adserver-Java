...
<head>
	...
	<title>AdSapient Ad Serving Solutions - System Requirements and Installation of AdSapient Ad Network</title>
...
<tr><td class="title2">System Requirements and Installation</td></tr>
...
<br>&nbsp;&nbsp;&nbsp;All software that should be preinstalled to run AdSapient is free. If you experience problems installing or setting up AdSapient, <a class="promotext2" href="../contact.jsp">contact us</a> for assistance.</td></tr>
<tr><td>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1">
				...
				<tr>
					...
					<td class="featuresbody"><a href="http://www.jboss.org" target="_blank" class="promotext2">JBoss 3.0</a>  or any other application server</td>
					<td class="featuresbody">JBoss 3.2</td>
				</tr>
				<tr>
					<td class="featuresbody">Database Server</td>
					<td class="featuresbody"><a href="http://www.mysql.com/" target="_blank" class="promotext2">MySQL 3.23 </a> or any other relational database</td>
