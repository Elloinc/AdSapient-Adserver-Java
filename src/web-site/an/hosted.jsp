...
<head>
	...
	<title>AdSapient Ad Serving Solutions - AdSapient Ad Network Hosted Solution</title>
...
<tr><td class="title2">AdSapient Ad Network Managed Solution</td></tr>
<tr><td class="promotext">&nbsp;&nbsp;&nbsp;AdSapient Ad Network software is not easy to handle technically when it comes to serving large volumes of ad views. Sometimes more than one ad server is necessary to install. Also a dedicated database server would be required. We offer a special managed solution which saves you the trouble of installation, setup and support. 
<br><br>
Here is what you will receive with this offer:<br><br>
<li>scalable application hosting at a reliable hoster (datacenter in US)<br></li>
<br><li>dedicated ad server<br></li>
<br><li>price for the server hosting is included<br></li>
<br><li>full 24/7 technical support (installation, db monitoring and cleaning,
load balancing, failover, data migration, etc.)<br></li>
<br><li>regular free software updates<br></li>
<br><li>free help in teaching your stuff to handle the software (one course
for 1-5 people delivered remotely per telephone/email/instant
messanger)<br></li>
<br>
To learn the prices for managed solution <a class="promotext2" href="../bm/purchase.jsp">click here</a>.<br>
<a class="promotext2" href="../contact.jsp">Contact us</a> to order managed solution.
