...
<html:form action="advertizerStatistic">
	 <html:hidden property="statisticType"/>
	 <html:hidden property="campainId"/>
	 <html:hidden property="bannerId"/>
	 <html:hidden property="report" styleId="reportId"/>
...
<tr> <td>
	...
	<tr>  
		...
		<td class="tabledata-c"><html:submit/>&nbsp;<html:submit onclick="report('exel');"/></td> 	
   </tr>
