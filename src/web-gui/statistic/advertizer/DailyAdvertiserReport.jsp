...
<tr> <td>
	...
	<td><table border="0" style="background-color:#ffffff;" cellspacing="1" width="100%"><tr>
		<td height="10"  width="10%"  class="tabletableheader">&nbsp;<bean:message key="date"/></td>
		<td height="10"  width="10%" class="tabletableheader">&nbsp;<bean:message key="uniques"/></td>
		...
		<td height="10"  width="5%" class="tabletableheader">&nbsp;<bean:message key="ltr"/></td>
		<td height="10"  width="5%" class="tabletableheader">&nbsp;<bean:message key="str"/></td>
		<td height="10"  width="15%" class="tabletableheader">&nbsp;<bean:message key="adviews.uniques"/></td>
