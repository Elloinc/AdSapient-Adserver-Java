<%@ page
	import="com.adsapient.shared.service.I18nService,com.adsapient.api_impl.statistic.publisher.AdditionalPublisherStatistic,
	com.adsapient.util.security.*,
	com.adsapient.api_impl.statistic.common.*,
	com.adsapient.shared.service.TimeService,java.util.*"%>
	...
	<table width="100%" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<table border="0" style="background-color:#ffffff;" cellspacing="1"
				width="100%">
				<tr>
					<td height="10" width="5%" class="tabletableheader">&nbsp;<bean:message
						key="id" /></td>
					<td height="10" width="15%" class="tabletableheader">&nbsp;<bean:message
						key="campaign.name" /></td>
