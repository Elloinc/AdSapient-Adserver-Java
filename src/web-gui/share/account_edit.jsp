<%@	page import="com.adsapient.util.*"%>
...
<tr><td>
	...
	<td height="10"  class="maintext"><table border="0" width="100%" cellspacing="5"><tr><td>&nbsp;&nbsp;<%=Msg.fetch(form.getCurrentBalanceName(),request)%>:</td></tr></table></td>
