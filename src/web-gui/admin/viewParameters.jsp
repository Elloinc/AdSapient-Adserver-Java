...
<tr><td>
	...
	<tr>
		...
		<td height="10" class="tabledata-c"><nobr><a class="tabledata" href="<%=response.encodeURL("parameter.do?action=removeParameter&parameterId="+param.getParameterId())%>" onClick="return window.confirm('<%=(Msg.fetch("delete.confirm",session)+" "+param.getParameterId())%>');"><img src="images/icons/remove.png" border="0" title=<bean:message key="remove"/>></a></nobr></td>
	</tr>
	</logic:iterate>	
