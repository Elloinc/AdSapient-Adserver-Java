...
<%@ page import="com.adsapient.shared.dao.HibernateEntityDao" %>
                    ...
                    <table border="0" style="background-color:#ffffff;" cellspacing="1" width="100%" cellpadding="0"
                        ...
                        <logic:iterate id="user" name="viewUsersForm" property="users">
                            ...
                            <tr>
                                ...
                                <td class="tabledata-c"><nobr><%=trs.getTotalUnitsByUser(u, AdsapientConstants.ADVIEW, RoleController.ADVERTISER)%></nobr></td>
                                <td class="tabledata-c"><nobr><%=trs.getTotalUnitsByUser(u, AdsapientConstants.CLICK, RoleController.ADVERTISER)%></nobr></td>
                                <td class="tabledata-c"><nobr><%=trs.getTotalUnitsByUser(u, AdsapientConstants.ADVIEW, RoleController.PUBLISHER)%></nobr></td>
                                <td class="tabledata-c"><nobr><%=trs.getTotalUnitsByUser(u, AdsapientConstants.CLICK, RoleController.PUBLISHER)%></nobr></td>
                                ...
                                <td class="tabledata-c"><nobr><a class="tabledata"
                                                                 ...
                                                                 onClick="return window.confirm('<%=(Msg.fetch("reset.confirm",session))%>');"><img
                               ...
                               <%-- <td class="tabledata-c"><nobr><%=iterUser.getLoginHref(request, response)%></nobr></td> --%>
                                <td class="tabledata-c"><nobr><a class="tabledata"
                                                                 ...
                                                                 onClick="return window.confirm('<%=(Msg.fetch("delete.confirm",session)+" User "+iterUser.getId())%>');"><img
