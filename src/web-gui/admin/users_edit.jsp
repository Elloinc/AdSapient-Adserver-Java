<%@ page import="com.adsapient.gui.forms.EditUserForm"%>
...
<% EditUserForm form = (EditUserForm)request.getAttribute("editUserForm"); %>
...
<tr><td>
	...
	<tr>
	<td width="5" heigh="10" style="background-image: url(images/table4.gif);"></td>
	<td height="10"  class="maintext"><table border="0" width="100%" cellspacing="5"><tr><td>&nbsp;&nbsp;<bean:message key="login.username"/>:&nbsp;&nbsp;<sup>*</sup></td></tr></table></td>
	<td ><table border="0" width="100%" cellspacing="5"><tr><td><html:text  style="width:150" property="login" maxlength="50"/></td></tr></table></td>
	<td width="6" heigh="10" style="background-image: url(images/table5.gif);"></td>
	</tr>
	<tr>
	<td width="5" heigh="10" style="background-image: url(images/table4.gif);"></td>
	...
	<td ><table border="0" width="100%" cellspacing="5"><tr><td><html:password size="10" style="width:150" property="password" maxlength="30"/></td></tr></table></td>
	<td width="6" heigh="10" style="background-image: url(images/table5.gif);"></td>
	</tr>
	<tr>
	<td width="5" heigh="10" style="background-image: url(images/table4.gif);"></td>
	...
	<td ><table border="0" width="100%" cellspacing="5"><tr><td><html:select  property="userRole" >
