...
<tr><td>
	...
	<tr>
		...
		<td height="10" class="tabledata-c"><nobr><a class="tabledata" href="<%=response.encodeURL("upload.do?action=removeBanner&bannerId=" + banner.getBannerId())%>" onClick="return window.confirm('<%=Msg.fetch("delete.confirm",session)%>');"><img src="images/icons/remove.png" border="0" title=<bean:message key="remove"/>></a></nobr></td>
					</tr>
				</logic:iterate>
				<tr>
