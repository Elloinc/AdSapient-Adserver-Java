...
<html:form action="adminOptions">
    ...
    <tr><td>
        <table width="100%" cellspacing="0" cellpadding="0"><tr>
            ...
            <td width="100%" class="tableheader"><bean:message key="admin.defaultsyssettings"/></td>
    ...
    <tr><td>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td height="10" class="maintext">&nbsp;&nbsp;<html:radio value="2" property="defaultTarget"/>&nbsp;&nbsp;
                    <bean:message key="default.targ.wind.self"/></td>
                <td width="6" heigh="10" style="background-image: url(images/table5.gif);"></td>
            </tr>

            <tr>
                <td width="5" heigh="10" style="background-image: url(images/table4.gif);"></td>
                <td height="10" class="maintext">&nbsp;&nbsp;<html:radio value="3" property="defaultTarget"/>&nbsp;&nbsp;
                    <bean:message key="default.targ.wind.new"/></td>
                <td width="6" heigh="10" style="background-image: url(images/table5.gif);"></td>
            </tr>
