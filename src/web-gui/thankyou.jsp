...
<tr><td>
	...
	<td width="100%" class="tableheader"><bean:message key="login.contact.thankyou.title"/></td>
...
<tr><td>
	...
	<td height="10" colspan="2" class="maintext"><table border="0" width="100%" cellspacing="5"><tr><td class="maintext">&nbsp;&nbsp;<bean:message key="login.contact.thankyou.text"/></td></tr></table></td>
