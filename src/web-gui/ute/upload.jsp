...
<tr><td>
	<table width="100%" cellspacing="0" cellpadding="0"><tr>
		...
		<tr>
			...
			<td height="10" class="tabledata"><table border="0" width="100%" cellspacing="5"><tr><td class="maintext"><html:textarea style="width: 370px; height: 50px;" property ="URL"/></td></tr></table></td> 
		</tr>
		<tr>
