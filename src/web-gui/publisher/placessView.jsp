<%@ page
        import="com.adsapient.shared.mappable.PlacesImpl,
                com.adsapient.shared.mappable.SiteImpl,
...
<logic:iterate id="siteMy" name="publisherActionForm"
    ...
    <tr>
        ...
        <td height="10" class="tabledata-c"><nobr><%=lhs.generateRates(session,
                places, response)%><br/><%=lhs.generateCPLRates(session,
        ...
        <td height="10" class="tabledata-c"><nobr>
            ...
            <%if (lhs.checkResetAccess(request)) {%>
                <%-- <a class="tabledata"
            ...
            <a class="tabledata" href="<%=response.encodeURL("totals.do?placeId="+places.getId())%>" 
               onClick="return window.confirm('<%=(i18nService.fetch("reset.confirm",session))%>');">
