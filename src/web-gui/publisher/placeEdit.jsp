...
<tr><td>
    <table width="100%" cellspacing="0" cellpadding="0"><tr>
        ...
        <td width="100%"
            class="tableheader"><%=i18nService.fetch(form.getAction() + ".adplace.title", session)%> <%=(form.getPlacesId() != null ? "#" + form.getPlacesId() : "")%></td>
...
<tr>
    ...
    <td height="10" >
        <table border="0" width="100%" cellspacing="5"><tr><td >
            <input type="submit"
                   value='<%=i18nService.fetch(form.getAction()+".adplace.button",session)%>'
            ...
            &nbsp;&nbsp;&nbsp;<input type="button" value='<bean:message key="remove"/>'
                                     onclick="selectionChanged();if( window.confirm('<%=i18nService.fetch("delete.confirm",request)%>')) {document.location='<%=response.encodeURL("placeEdit.do?placeAction=remove&placesId="+form.getPlacesId())%>'}">
            <%}%>
        </td></tr></table>
    </td>
    <td width="6" heigh="10" style="background-image: url(images/table5.gif);"></td>
