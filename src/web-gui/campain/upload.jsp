...
<tr><td>
	...
	<td width="100%" class="tableheader"><bean:message key="banner.add.title"/></td>
...
<tr><td>
	<table width="100%" cellspacing="0" cellpadding="0"><tr>
		...
		<tr>
			...
			<td height="10" class="tabledata"><table border="0" width="100%" cellspacing="5"><tr><td class="maintext"><html:text  property="bannerName" size="28" maxlength="50"/></td></tr></table></td>
		</tr> 
		<tr>
