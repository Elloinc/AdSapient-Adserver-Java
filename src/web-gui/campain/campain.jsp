...
<%CampainImpl campain= (CampainImpl) campainsMy;%>
	...
	<td height="10" class="tabledata-c"><nobr><%=lhs.generateCPLRates(session,campain,response)%></nobr></td>
    ...
    <td height="10" class="tabledata-c"><nobr><a class="tabledata" href="<%=response.encodeURL("totals.do?campaignId="+campain.getCampainId())%>" onClick="return window.confirm('<%=(i18nService.fetch("reset.confirm",session))%>');"><img src="images/icons/resetstats.gif" border="0" title='<bean:message key="reset"/>'/></a></nobr></td>
	<td height="10" class="tabledata-c"><nobr><a class="tabledata" href='<%=response.encodeURL("campainEdit.do?action=remove&campainId="+campain.getCampainId())%>' onClick="return window.confirm('<%=(i18nService.fetch("delete.confirm",session)+" "+campain.getCampainId())%>');"><img src="images/icons/remove.png" border="0" title=<bean:message key="remove"/>></a></nobr></td>
