...
<head>
	...
	<title>AdSapient Ad Serving Solutions - Purchase AdSapient Banner Manager</title>
...
<td width="156" height="3"style="background-image: url(../images/vert.gif);"></td>
...
<tr><td class="title2">Purchase AdSapient Banner Manager</td></tr>
<tr><td class="promotext">&nbsp;&nbsp;&nbsp;The pricing is based on the number of monthly impressions you plan to deliver with AdSapient. In case you exceed that number you can always upgrade the license for the difference in price. </td></tr>
<tr><td class="promotext">&nbsp;&nbsp;&nbsp;<b>Pricing for AdSapient Banner Manager Hosted Service:</b></td></tr>
<tr><td>
...
<!--						<tr>
						  <td class="featuresheader"><nobr>Setup fee:</nobr></td>
						  <td class="featuresheader"><nobr>25$</nobr></td>
                        </tr>-->
<tr>
                          <td class="featuresheader"><nobr>Monthly Imressions</nobr></td>
						  <td class="featuresheader"><nobr>Monthly Fee</nobr></td>
                        </tr>
				<tr>
					<td class="featuresbody">less than 1,000,000</td>
					<td class="featuresbody">$1 USD / 10,000 (no setup fee; first 10,000 are free)</td>
				</tr>
				<tr>
					<td class="featuresbody">1,000,000*</td>
					<td class="featuresbody">$100.00 USD</td>
				</tr>
				<tr>
					<td class="featuresbody">3,000,000</td>
					<td class="featuresbody">$270.00 USD</td>
				</tr>
				<tr>
					<td class="featuresbody">5,000,000</td>
					<td class="featuresbody">$450.00 USD</td>
				</tr>
				<tr>
					<td class="featuresbody">10,000,000</td>
					<td class="featuresbody">$900.00 USD</td>
				</tr>
				<tr>
					<td class="featuresbody">25,000,000</td>
					<td class="featuresbody">$2,300.00 USD</td>
				</tr>
				<tr>
					<td class="featuresbody">50,000,000</td>
					<td class="featuresbody">$4,000.00 USD</td>
				</tr>
				<tr>
					<td class="featuresbody">100,000,000</td>
					<td class="featuresbody">$7,500.00 USD</td>
				</tr>
				<tr>
					<td class="featuresbody">More?</td>
					<td class="featuresbody"><a class="promotext2" href="../contact.php">Contact Us</a></td>
				</tr>
						<tr>
						  <td colspan="2" class="featuressubheader"><nobr>*The price is calculated based on the exact number of served impressions within one month of ad serving and pricing policy for the served volume</nobr></td>
                        </tr>
</table>
</td>
</tr>
...
<tr><td class="promotext"><br>&nbsp;&nbsp;&nbsp;<b>Pricing for AdSapient Banner Manager (Software Solution):</b></td></tr>
...
<tr>
                          <td class="featuresheader"><nobr>Monthly Impressions</nobr></td>
						  <td class="featuresheader"><nobr>One-Time License Cost</nobr></td>
						  <td class="featuresheader"><nobr>Yearly Support Fee*</nobr></td>
                        </tr>
				<tr>
					<td class="featuresbody">1,000,000</td>
					<td class="featuresbody">$200.00 USD</td>
					<td class="featuresbody">$99.00 USD</td>
				</tr>
				<tr>
					<td class="featuresbody">3,000,000</td>
					<td class="featuresbody">$400.00 USD</td>
					<td class="featuresbody">$99.00 USD</td>
				</tr>
				<tr>
					<td class="featuresbody">5,000,000</td>
					<td class="featuresbody">$500.00 USD</td>
					<td class="featuresbody">$99.00 USD</td>
				</tr>
				<tr>
					<td class="featuresbody">10,000,000</td>
					<td class="featuresbody">$600.00 USD</td>
					<td class="featuresbody">$199.00 USD</td>
				</tr>
				<tr>
					<td class="featuresbody">25,000,000</td>
					<td class="featuresbody">$700.00 USD</td>
					<td class="featuresbody">$199.00 USD</td>
				</tr>
				<tr>
					<td class="featuresbody">50,000,000</td>
					<td class="featuresbody">$1400.00 USD</td>
					<td class="featuresbody">$299.00 USD</td>
				</tr>
				<tr>
					<td class="featuresbody">100,000,000</td>
					<td class="featuresbody">$2800.00 USD</td>
					<td class="featuresbody">$299.00 USD</td>
				</tr>

				<tr>
					<td class="featuresbody">More?</td>
					<td colspan="2" class="featuresbody"><a class="promotext2" href="../contact.php">Contact Us</a></td>
				</tr>
						<tr>
						  <td colspan="3" class="featuressubheader"><nobr>*Support is optional. In many cases it can be rendered on a per-hour basis and the price will be calculated separately.</nobr></td>
                        </tr>
</table>
</td>
</tr>
...
<tr><td class="promotext">&nbsp;&nbsp;&nbsp;To ensure that your order is processed correctly and that your choice of the software / hosted service pricing plan is the right one for you, <a class="promotext2" href="../contact.php">contact us</a>. We will send you a custom agreement and our payment information. </td></tr>
</table>
</td>
<td height="174" width="3" style="background-image: url(../images/hor.gif);"></td>
</tr>
