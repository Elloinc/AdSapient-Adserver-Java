...
<?php
	...
	if (isset($_REQUEST['request'])) {
		...
		if($flag) {
			...
			$body = "<html><head><title>AdSapient Banner Manager Demo Request</title></head>
				<body> <br>
					<div style='margin-left: 100px'>
						Company: {$_REQUEST['Company']}<br>  						
						Name: {$_REQUEST['Name']}<br>  
						Phone: {$_REQUEST['Phone']}<br> 
						Email:{$_REQUEST['Email']}<br>  					</div>
				</body>
				</html>";
			mail($email_to, 'Banner Manager Demo Request', $body, $header) or die("Email error: contact with admin");
...
<head>
	...
	<title>AdSapient Ad Serving Solutions - Demonstration of AdSapient Banner Manager</title>
...
<tr><td colspan="2" class="promotext">&nbsp;&nbsp;&nbsp;You are a minute away from viewing an online fully functional demo of AdSapient Ad Network. Its functionality is very similar to that of AdSapient Banner Manager. 
...
If you are hesitant about revealing your contact information read our <a class="promotext2" href="../privacy.php">privacy policy</a>.
